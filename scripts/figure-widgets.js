...
export const RATIO = `<div class="ratio" data-ratio>
        ...
        <p class="ratio__keys">
          <span><b>code</b> <span data-ratio-code-val>18,876</span> lines</span>
...
export function mountRatio(host) {
  ...
  btn.addEventListener('click', () => {
    shown = !shown;
    // 18,876 lines of code against 17,610 of writing, git-tracked, counted 7 August 2026
    host.querySelector('[data-ratio-code]').style.width = shown ? '51.7%' : '100%';
    host.querySelector('[data-ratio-prose]').style.width = shown ? '48.3%' : '0%';
    host.querySelector('[data-ratio-prose-val]').textContent = shown ? '17,610' : '0';

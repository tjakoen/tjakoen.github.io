...
Tour review-form-from-data, dev mode. Captured 2026-08-12T21:15:37.467Z.

The app under review was http://localhost:3000, loaded through PANTRY at http://localhost:59391, so these are
...
- verdict: ok
- status: new
- url: http://localhost:59391/about#contact
...
- verdict: ok
- status: known-issue
- url: http://localhost:59391/about#contact (no navigation; the page the step before it left)

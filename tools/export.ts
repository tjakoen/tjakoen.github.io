...
// /grain/builder's own island (ai/builder-canvas.js) is an entry for a different reason: it is reached by
...
// graph. Without it the frozen /grain/builder ships the island's URL and 404s on it, which is precisely

...
All live in [`ten-times-zero.md`](/notes/ten-times-zero). Data-viz: the **docs-vs-code
...
the one-door flow in [`whitepaper-one-vocabulary.md`](/notes/whitepaper-one-vocabulary) and
